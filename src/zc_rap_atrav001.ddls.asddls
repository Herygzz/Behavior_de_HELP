...
define root view entity ZC_RAP_ATRAV001
  provider contract transactional_query
  as projection on ZR_RAP_ATRAV001
{
  ...
  key     TravelId,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_CALCULA'
          @EndUserText.label: 'TotTax Virtual'
  virtual TotalTax : /dmo/total_price
