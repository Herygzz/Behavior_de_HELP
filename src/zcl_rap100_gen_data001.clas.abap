CLASS zcl_rap100_gen_data001 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data001 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    DELETE FROM zrap_atrav001.

    "insert travel demo data
    INSERT zrap_atrav001 FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZRAP_ATRAV{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
